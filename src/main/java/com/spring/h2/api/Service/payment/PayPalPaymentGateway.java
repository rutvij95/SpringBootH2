...
public class PayPalPaymentGateway implements PaymentGateway {
    ...
    public String processPayment(String paymentId, BigDecimal amount, String paymentMethod) {
        ...
        try {
            ...
            if (Math.random() < 0.85) {
                return "PP_TXN_" + UUID.randomUUID().toString().substring(0, 8);
            } else {
    ...
    public boolean verifyPayment(String transactionId) {
        ...
        return transactionId != null && transactionId.startsWith("PP_TXN_");
    }

    @Override
    public void refundPayment(String transactionId, BigDecimal amount) {
        // Simulate refund processing
        System.out.println("Processing PayPal refund for transaction: " + transactionId + " amount: " + amount);
    }
